...
export default function Home() {
  return (
    <div className="px-6 md:px-6 pt-16 md:pt-20  max-w-[700px] mx-auto">
        <div className="flex flex-col gap-16 md:gap-24">
          <div className="flex animate-in flex-col gap-8">
            ...
            <p className="max-w-lg animate-in text-primary">
              Hi, I'm Erick Lopez! A computer science student born and raised in Oklahoma City attending Oklahoma State University - Online. I enjoy building whatever comes to mind with code. From websites to mobile apps I enjoy doing it all.
            </p>
